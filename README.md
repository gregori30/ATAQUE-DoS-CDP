...
Uso de LLDP con Seguridad: Cambiar a LLDP (Link Layer Discovery Protocol), que es el estándar abierto, y configurar filtros específicos si el hardware lo permite.# ATAQUE-DoS-CDP
